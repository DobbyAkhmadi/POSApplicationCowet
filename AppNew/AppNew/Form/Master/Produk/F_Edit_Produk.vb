...
#End Region
    ...
    Private Sub get_data_view()
        format_currency()
        txtid.Text = F_Produk.GridView1.GetFocusedRowCellValue("ID Produk").ToString
        LookUpEdit1.EditValue = F_Produk.GridView1.GetFocusedRowCellValue("Kategori")
        txtnama.Text = F_Produk.GridView1.GetFocusedRowCellValue("Nama Produk").ToString
        txtbeli.Text = Convert.ToDouble(F_Produk.GridView1.GetFocusedRowCellValue("Harga Beli"))
        txtjual.Text = Convert.ToDouble(F_Produk.GridView1.GetFocusedRowCellValue("Harga Jual"))
        txtstok.Text = Convert.ToInt16(F_Produk.GridView1.GetFocusedRowCellValue("Stok"))
    End Sub
    ...
    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        ...
        Else
            Try
                Update_Produk(txtid.EditValue, LookUpEdit1.EditValue, txtnama.EditValue, txtbeli.EditValue, txtjual.EditValue, txtstok.EditValue)
                Pesan_Ubah()
                clear_field()
