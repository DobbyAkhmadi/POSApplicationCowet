...
Public Class F_Transaksi_Retur_Jual
...
#Region "Event"
    ...
    End Sub
    Private Sub LookUpEdit2_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles LookTransaksi.EditValueChanged
        Try
            Get_View_Lookup()
            currency()
...
#Region "CRUD"
    ...
    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        ...
        Update_Detail_Retur()
        Pesan_Simpan()
        DirectPrint_Faktur("Rpt\Rpt_R_Jual.rpt", "TBL_RETUR_PENJUALAN.id_retur", TxtNoTrans.Text)
        Clear_Adapter()
        Activated_(0)
        Clear_()
    ...
    Private Sub BtnTambah_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnTambah.Click
        If LookTransaksi.EditValue = "" Then
            Pesan_Peringatan("Pilih dulu yah produknya :)")
        Else
            Try
                DataGrid.Rows.Clear()
                Clear_Adapter()
                Get_View_Retur_Detail()
                Total_Harga()
                currency()
            Catch ex As Exception
                Pesan_Error("" + ex.Message + "" + CRUD_Module.pesan_error + "")
