...
Public Class Rpt_Daftar_Barang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppNew.Rpt_Daftar_Barang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Daftar_Barang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Daftar_Barang = New Rpt_Daftar_Barang()
        rpt.Site = Me.Site
        Return rpt
    End Function
