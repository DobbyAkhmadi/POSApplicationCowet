...
Public Class Rpt_R_Pembelian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppNew.Rpt_R_Pembelian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_R_Pembelian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_R_Pembelian = New Rpt_R_Pembelian()
        rpt.Site = Me.Site
        Return rpt
    End Function
